...
RSpec.describe Clients do
  ...
  describe '.all' do
    it 'loads clients from the specified file path' do
      allow(LoadData).to receive(:call).with(test_file_path).and_return(sample_clients)
  ...
  describe '.search' do
    it 'searches for clients matching the query' do
      ...
      expect(result).to eq([sample_clients.first])
  ...
  describe '.find_duplicates' do
    it 'finds duplicate clients' do
      ...
      expect(result).to eq(duplicate_groups)
